...
if __name__ == '__main__':
	...
	# stage 2 will search for a string and print excercepts from all the requests where they are presen. It will as well print what is around it.
	# That way, you can see what the heartbleeds have in common and use this to merge your key together.
	...
	#stage2("\x01\x00\x30\x0d\x06", 40, 5) # Notice how this is to the left of the leftmost bytes we know

	# Use stage2 to merge together the private key. When you see two bytes of 00 and random noise, you are at end or beginning.
